...
const LabResultUploadOutputSchema = z.object({
  ...
  hba1c: z.object({
    value: z.number().optional().describe('The HbA1c result extracted from the lab result (as a percentage).'),
  }).optional().describe('The HbA1c result extracted.'),
