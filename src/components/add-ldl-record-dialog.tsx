...
export function AddLdlRecordDialog({ children }: AddLdlRecordDialogProps) {
  ...
  const onSubmit = (data: z.infer<typeof FormSchema>) => {
   ...
   const triggerButton = children || (
      <AddRecordButton tooltipContent="Add LDL Record" />
   );
  ...
  return (
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            <DialogTitle>Add New LDL Cholesterol Record</DialogTitle>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 py-4">
              ...
              <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>LDL Cholesterol ({unitLabel})</FormLabel>
                      <FormControl>
