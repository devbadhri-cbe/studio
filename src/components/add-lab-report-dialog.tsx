...
export function AddLabReportDialog({ onCancel }: AddLabReportDialogProps) {
  const { 
    addHba1cRecord,
    ...
    <Dialog open={true} onOpenChange={(open) => !open && onCancel()}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>Enter all available results from your lab report. Unfilled fields will be ignored.</DialogDescription>
        </DialogHeader>
