...
export function PatientHeader({ children }: PatientHeaderProps) {
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row items-center gap-4">
      ...
      <div className="w-full md:w-auto flex flex-1 items-center justify-end gap-4">
        <div className="flex-1 flex items-center gap-2 text-sm text-muted-foreground md:justify-center">
